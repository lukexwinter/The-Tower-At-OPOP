	...
	$.fn.textCaptcha = function(options) {
		...
		return this.each(function() {
			...
			function output(el) {
				...
				// $('div[id^="list"]');
				var output = '<div class="security-question"><em>(Security Question)</em>';
				output += '<input type="text" id="captcha_user_'+ identifier + '" name="captcha_user" class="textbox" placeholder="'+ captcha_method_text +' '+ captcha_string + '*" /></div>';

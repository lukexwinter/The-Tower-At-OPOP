...
<div class="floorplan">
	<div class="fp-image">
		<img src="<?php echo MAINURL."live-site/img/05-floorplan.png"; ?>" alt="" />
	</div>
	<div class="fp-info">
		<h1>05</h1>
		<p>
		...
		<ul class="clearfix">
			...
			<li>One Bathroom</li>
			<li>747 sq ft</li>
			<li><a href="<?php echo MAINURL."live-site/pdf/05.pdf"; ?>" target="_blank">Download Floor Plan</a></li>
		</ul>

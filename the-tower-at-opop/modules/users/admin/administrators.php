...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#jqTable").jqGrid({
			...
			colModel:[				
				{name:'fullname',index:'u.lastname, u.firstname'},
				{name:'status',index:'u.status', align:"center", width:80, fixed: true},
				{name:'options',index:'options', align:"center", width:80, fixed: true, sortable: false}								
			],
			cmTemplate: { title: false },
			postData: {listAdministrators: true},
			pager: '#pager',
			sortname: 'u.lastname, u.firstname',
			viewrecords: true,
			sortorder: "ASC",
			loadonce: false,
			multiselect: true,
